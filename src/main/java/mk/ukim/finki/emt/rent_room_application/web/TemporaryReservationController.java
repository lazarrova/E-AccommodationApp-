...
public class TemporaryReservationController {
   private final TemporaryReservationApplicationService temporaryReservationApplicationService;
    ...
    public List<DisplayAccomodationDto> getAllAccommodationsInTempRes(Authentication authentication){
    ...
    public ResponseEntity<TemporaryReservstionDto> addAccommodationToTempRes(Authentication authentication, @PathVariable Long id){
        try{
    ...
    @PostMapping("/confirm")
    public ResponseEntity<TemporaryReservstionDto>confirmReservation(Authentication authentication){
        try {
            User user = (User) authentication.getPrincipal();
